...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { name: 'API', href: '/api' },
      { name: 'GitHub', href: 'https://github.com/instantWebsiteAi' },
    ],
    legal: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div className="lg:col-span-2" variants={itemVariants}>
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              No builders. No fluff. Just your website.
            </p>
            
            <div className="flex space-x-4">
              <motion.a
                href="https://twitter.com/instantWebsiteAi"
                target="_blank"
              ...
              <motion.a
                href="https://github.com/instantWebsiteAi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                whileHover={{ scale: 1.1 }}
              ...
              <motion.a
                href="https://linkedin.com/company/instantWebsiteAi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                whileHover={{ scale: 1.1 }}
        ...
        >
          ...
          <motion.div className="mt-4 md:mt-0" variants={itemVariants}>
            <Link
              href="/demo"
              className="inline-flex items-center px-6 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
            >
              Try Demo
            </Link>
          </motion.div>
